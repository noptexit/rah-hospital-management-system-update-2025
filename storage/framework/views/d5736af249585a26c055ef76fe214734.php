...
<div class="aside-menu-container" id="sidebar">
    ...
    <div class="aside-menu-container__aside-logo flex-column-auto">
        <!--begin::Logo-->
        <a href="<?php echo e(!getLoggedInUser()->hasRole('Super Admin') ? route('front', $username->username) : url('/')); ?>"
           data-toggle="tooltip" data-placement="right"
           data-turbo="false"
           class="text-decoration-none sidebar-logo"
           title="<?php echo e(getAppName()); ?>" target="_blank">
            <img src="<?php echo e(!getLoggedInUser()->hasRole('Super Admin') ? asset($hospitalSettingValue['app_logo']['value']) : asset($settingValue['app_logo']['value'])); ?>"
                 width="50px" height="50px"
                 alt="Logo"/>
            <span class="navbar-brand-name text-dark text-decoration-none logo ps-2"><?php echo e((!getLoggedInUser()->hasRole('Super Admin') ? $hospitalSettingValue['app_name']['value'] : $settingValue['app_name']['value'])); ?></span>
        </a>
    ...
    <form class="d-flex position-relative aside-menu-container__aside-search search-control py-3 mt-1">
        <div class="position-relative w-100 sidebar-search-box">
            <input class="form-control" type="text" placeholder="<?php echo e(__('messages.common.search')); ?>" id="menuSearch" aria-label="Search">
...
<?php /**PATH /home/sadhin/Documents/hms-hosptalcare/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>