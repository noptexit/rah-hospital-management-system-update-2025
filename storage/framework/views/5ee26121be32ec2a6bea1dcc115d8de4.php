    ...
    <div class="d-flex flex-column">
        <div class="row">
            <div class="col-12 mb-4">
                <div class="row">
                        ...
                        <a href="<?php echo e(route('super.admin.hospitals.index')); ?>"
                            ...
                            <div
                                ...
                                <div class="text-end text-white">
                                    ...
                                    <h2 class="fs-1-xxl fw-bolder text-white"><?php echo e(formatCurrency($users)); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-light text-white">
                                        <?php echo e(__('messages.dashboard.total_hospitals')); ?></h3>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                        <a href="<?php echo e(route('subscriptions.transactions.index')); ?>" class="text-decoration-none">
                            <div
                                ...
                                <div
                                    ...
                                    <span
                                        class="text-white fs-1-xl"><?php echo e(isset($currency) ? $currency->currency_icon : ''); ?></span>
                                </div>
                                <div class="text-end text-white">

                                    <h2 class="fs-1-xxl fw-bolder text-white"><?php echo e(formatCurrency($revenue, 2)); ?>

                                    </h2>
                                    <h3 class="mb-0 fs-5 fw-light text-white">
                                        <?php echo e(__('messages.dashboard.total_revenue')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                        <a href="<?php echo e(route('super.admin.subscription.plans.index')); ?>" class="text-decoration-none">
                            <div
                                ...
                                <div class="text-end text-white">
                                    <h2 class="fs-1-xxl fw-bolder text-white">
                                        <?php echo e(formatCurrency($activeHospitalPlan)); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-light text-white">
                                        <?php echo e(__('messages.dashboard.total_active_hospital_plan')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                        <a href="<?php echo e(route('super.admin.subscription.plans.index')); ?>" class="text-decoration-none">
                            <div
                                ...
                                <div class="text-end text-white">
                                    <h2 class="fs-1-xxl fw-bolder text-white">
                                        <?php echo e(formatCurrency($deActiveHospitalPlan)); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-light text-white">
                                        <?php echo e(__('messages.dashboard.total_expired_hospital_plan')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
        ...
        <div class="row mt-4">
            <div class="col-lg-12 col-xl-3 col-md-12 col-sm-12">
                <h1><?php echo e(__('messages.dashboard.income_report')); ?></h1>
            </div>
            <div class="col-lg-6 col-xl-3 col-md-6 col-sm-6 ms-auto">
                <div class="form-group mb-3 d-flex">
                    ...
                    <input class="form-control" autocomplete="off"
                        placeholder="<?php echo e(__('messages.dashboard.please_select_rang_picker')); ?>" id="chartFilter"
                        wire:ignore />
                </div>
            </div>
        </div>
...
<?php /**PATH /home/sadhin/Documents/hms-hosptalcare/resources/views/livewire/dashboard.blade.php ENDPATH**/ ?>