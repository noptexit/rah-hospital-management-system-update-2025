                        ...
                        <div class="patient-card-header d-flex align-items-center custom-card-header">
                            <div class="flex-1 d-flex align-items-center me-3">
                                <div class="patient-card-logo me-4">
                                    <img src="<?php echo e(asset(getSettingValue()['app_logo']['value'])); ?>" alt="logo" class="h-100 img-fluid" />
                                </div>
                            ...
                            <div class="flex-1 text-end">
                                <address class="text-white fs-12 mb-0">
                                    <p class="mb-0">
                                        <?php echo e(getSettingValueByKey('hospital_address')); ?>
                                    ...
                                    <div class="d-flex mb-3">
                                        ...
                                        <div class="">
                                            <table class="table table-borderless patient-desc mb-0">
                                                <tr class="cardName">
                                                    <td class="pe-3"><?php echo e(__('messages.item.name')); ?>:</td>
                                                    <td id="patientCardName"></td>
                                                </tr>
                                                <tr class="patientEmail d-none">
                                                    <td class="pe-3"><?php echo e(__('auth.email')); ?>:</td>
                                                    <td id="patientCardEmail"></td>
                                                </tr>
                                                <tr class="patientNumber d-none">
                                                    <td class="pe-3"><?php echo e(__('messages.web_home.contact')); ?>:</td>
                                                    <td id="patientCardMob"></td>
                                                </tr>
                                                <tr class="patientDob d-none">
                                                    <td class="pe-3"><?php echo e(__('messages.lunch_break.dob')); ?>:</td>
                                                    <td id="patientCardDob"></td>
                                                </tr>
                                                <tr class="patientBloodGroup d-none">
                                                    <td class="pe-3"><?php echo e(__('messages.user.blood_group')); ?>:</td>
                                ...
                                <div class="w-25">
                                    <div class="text-end">
                                        ...
                                        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Patient')): ?>
                                            <div class="text-end">
                                                <a title="<?php echo e(__('messages.expense.download')); ?>" class="btn px-5 fs-1 ps-0 download-icon" href="<?php echo e(url('smart-patient-card-download').'/'.Auth::user()->patient->id); ?>" target="_blank" data-bs-toggle="tooltip" data-bs-original-title="Download">
...
<?php /**PATH /home/sadhin/Documents/hms-hosptalcare/resources/views/smart-patient-cards/show_modal.blade.php ENDPATH**/ ?>