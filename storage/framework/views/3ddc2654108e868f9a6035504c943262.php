<div class="ms-0 ms-md-2" wire:ignore>
    <div class="dropdown d-flex align-items-center me-4 me-md-5">
        ...
        <div class="dropdown-menu py-0" aria-labelledby="prescriptionFilterBtn">
            ...
            <div class="p-5">
                <div class="mb-5">
                    <label for="prescriptionHead" class="form-label"><?php echo e(__('messages.common.status').':'); ?></label>
                    ...
                    <select class="form-select status-selector" id="prescriptionHead" data-control="select2" name="status">
                        ...
                        <option value="0"><?php echo e(__('messages.filter.deactive')); ?></option>
                    </select>
                </div>
                <div class="d-flex justify-content-end">
                    <button type="reset" id="prescriptionResetFilter" class="btn btn-secondary"><?php echo e(__('messages.common.reset')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/sadhin/Documents/hms-hosptalcare/resources/views/prescriptions/filter-button.blade.php ENDPATH**/ ?>