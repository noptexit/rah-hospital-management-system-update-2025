<div class="ms-auto" wire:ignore>
    <div class="dropdown d-flex align-items-center me-4 me-md-5">
        ...
        <div class="dropdown-menu py-0" aria-labelledby="dropdownMenuButton1">
            ...
            <div class="p-5">
                <div class="mb-10">
                    <label for="bed_assign_filter_status" class="form-label fs-6 fw-bold"><?php echo e(__('messages.common.status').':'); ?></label>
...
<?php /**PATH /home/sadhin/Documents/hms-hosptalcare/resources/views/bed_assigns/filter-button.blade.php ENDPATH**/ ?>