<div>
    ...
    <?php endif; ?>
    <?php if(Request::is('super-admin/dashboard')): ?>
    ...
    <?php endif; ?>
    <?php if(Request::is('patient/dashboard')): ?>
        <div class="admin-dashboard-skeleton">
            <div class="card">
                <div class="card-content">
                    <div class="d-flex justify-content-between">
...
<?php /**PATH /home/sadhin/Documents/hms-hosptalcare/resources/views/livewire/admin-dashboard-skeleton.blade.php ENDPATH**/ ?>