            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6  mb-5">
                        ...
                        <?php echo e(Form::select('module_name',\App\Models\CustomField::MODULE_TYPE_ARR ,null, ['id' => 'edit_module_name','class' => 'form-select edit-module-name','required','placeholder' => __('messages.custom_field.select_module'),'data-control' => 'select2'])); ?>
                    ...
                    <div class="col-md-6  mb-5">
                        ...
                        <span class="required"></span>
                        <?php echo e(Form::select('field_type',$fieldArray ,null,['id' => 'edit_field_type','class' => 'form-select edit-field-type','required','placeholder' => __('messages.custom_field.select_field_type'),'data-control' => 'select2'])); ?>
                    ...
                    <div class="col-md-6  mb-5">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <?php echo e(Form::text('grid', null, ['id'=>'edit_grid','class' => 'form-control','required', 'placeholder' => __('messages.custom_field.grid')])); ?>
...
<?php /**PATH /home/sadhin/Documents/hms-hosptalcare/resources/views/custom_fields/edit_custom_field_modal.blade.php ENDPATH**/ ?>