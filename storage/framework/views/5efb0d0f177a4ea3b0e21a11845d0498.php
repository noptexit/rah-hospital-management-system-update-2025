                        ...
                        <div class="hero-content">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-lg-start justify-content-center mb-lg-0 mb-5">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('messages.web_home.about_us')); ?></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-lg-6 text-lg-end text-center">
                        <img src="<?php echo e(asset('web_front/images/page-banner/about.png')); ?>" alt="Infy Care" class="img-fluid" loading="lazy" />
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-stretch flex-column-reverse flex-lg-row">
                    ...
                    <div class="col-lg-6">
                        <div class="about-right pb-5 pt-lg-5 text-lg-start text-center">
                            <h2 class="mt-md-3"><?php echo e(\Illuminate\Support\Str::limit($frontSetting['about_us_title'], 50)); ?></h2>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-6 text-center doctors-block my-lg-1">
                            <div class="px-lg-2 py-3">
                                <a href="<?php echo e(route('doctor.details',[$userName,$doctor->id])); ?>">
                                    ...
                                    <p class="mb-2">(<?php echo e(\Illuminate\Support\Str::limit($doctor->user->qualification, 25)); ?>)</p>
                                    <h5 class="text-success mb-0 fs-6 fw-normal">
                                        <?php echo e(\Illuminate\Support\Str::limit($doctor->specialist, 15)); ?> <?php echo e(__('messages.doctor.specialist')); ?>
...
<?php echo $__env->make('web.layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sadhin/Documents/hms-hosptalcare/resources/views/web/home/about_us.blade.php ENDPATH**/ ?>