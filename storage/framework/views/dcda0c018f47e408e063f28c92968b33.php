        ...
        <div class="dropdown-menu py-0" aria-labelledby="hospitalFilterBtn">
            ...
            <div class="p-5">
                <div class="mb-5">
                    ...
                    <?php echo e(Form::select('status',collect($filterHeads[0])->sortBy('key')->reverse()->toArray(),null, ['id' => 'hospitalStatusArr', 'data-control' =>'select2', 'placeholder'=> __('messages.common.select_status'),'class' => 'form-select status-selector select2-hidden-accessible data-allow-clear="true"'])); ?>
...
<?php /**PATH /home/sadhin/Documents/hms-hosptalcare/resources/views/super_admin/users/filter-button.blade.php ENDPATH**/ ?>